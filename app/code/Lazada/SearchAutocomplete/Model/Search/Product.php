...
namespace Lazada\SearchAutocomplete\Model\Search;
...
use \Lazada\SearchAutocomplete\Model\Source\AutocompleteFields;
use \Lazada\SearchAutocomplete\Model\Source\ProductFields;

/**
 * Product model. Return product data used in search autocomplete
 */
class Product implements \Lazada\SearchAutocomplete\Model\SearchInterface
{
    /**
    ...
    {
        /** @var \Lazada\SearchAutocomplete\Block\Autocomplete\ProductAgregator $productAgregator */
        $productAgregator = $this->objectManager->create(
            'Lazada\SearchAutocomplete\Block\Autocomplete\ProductAgregator'
        )
                                                ->setProduct($product);
