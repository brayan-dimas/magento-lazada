...
namespace Lazada\SearchAutocomplete\Block\Autocomplete;

use \Lazada\SearchAutocomplete\Block\Product as ProductBlock;
...
{
    /**
     * @var \Lazada\SearchAutocomplete\Block\Product
     */
    ...
    public function getAddToCartData()
    {
        $formUrl             = $this->productBlock->getAddToCartUrl(
            $this->getProduct(),
            ['Lazada_SearchAutocomplete' => true]
        );
