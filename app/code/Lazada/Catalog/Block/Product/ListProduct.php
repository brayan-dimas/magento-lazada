...
namespace Lazada\Catalog\Block\Product;

use Magento\Catalog\Api\CategoryRepositoryInterface;
use Unilab\Catalog\Block\Product\ProductList\Toolbar;
...
class ListProduct extends \Magento\Catalog\Block\Product\AbstractProduct implements IdentityInterface
{
    ...
    public function __construct(
        ...
        \Magento\Catalog\Model\Layer\Filter\Item $itemModel,
        \Lazada\Catalog\Helper\Data $catalogHelper,
    ...
    private function initializeProductCollection()
    {
        ...
        if(isset($params['unilab_benefit']) && !empty($params['unilab_benefit'])){
            $collection->addAttributeToFilter('unilab_benefit', array('finset' => array($params['unilab_benefit'])));
        }
        if(isset($params['unilab_segment']) && !empty($params['unilab_segment'])){
            $collection->addAttributeToFilter('unilab_segment', array('finset'=> array($params['unilab_segment'])));
        }
        if(isset($params['unilab_type']) && !empty($params['unilab_type'])){
            $collection->addAttributeToFilter('unilab_type', $params['unilab_type']);
        }
        if(isset($params['unilab_format']) && !empty($params['unilab_format'])){
            $collection->addAttributeToFilter('unilab_format', $params['unilab_format']);
        }
    ...
    public function resizeImage($product, $image_type, $width, $height = null)
    {
        $resizedImage = $this->productImageHelper->init($product, $image_type)
                                           ->constrainOnly(TRUE)
